...
<body>
<%
    List<Image> images = (List<Image>) session.getAttribute("labeledImages");
...
<div class="container">
    <div class="side-bar">
        ...
        <a class="side-bar-button" href="<%=request.getContextPath()%>/main/userspace/userspaceUnlabeled">未标注</a>
        <a class="side-bar-button" href="<%=request.getContextPath()%>/main/userspace/userspaceLabeled" style="background-color: #087DCE;color:white;">已标注</a>
    </div>
        ...
        <div class="work-area">
            ...
            <div class="operation-area">
                ...
                <form id="label-form" action="<%=request.getContextPath()%>/main/userspace/updateLabel" method="get" onsubmit="return checkImageNum()">
                    ...
                    <input type="text" name="fromPage" value="Labeled" style="display: none">
                    <input type="number" id="imageId" name="imageId" value="<%=currentImageId%>" style="display: none;">
                    <input type="text" name="classLabel" placeholder="类别" style="display: none">
