...
<div class="container">
    <div class="side-bar">
        ...
        <a class="side-bar-button" href="<%=request.getContextPath()%>/main/userspace/userSkillLearning_bbs.jsp" style="background-color: #087DCE;color:white;">如何加入讨论</a>
    </div>
    <div class="tasks-content">
        <div class="up-area">
            <div class="video-title">
                <span class="video-title-text">如何加入讨论👇</span>
            </div>
            <video id="teach-video" width="1080" height="640" controls>
                <source src="<%=request.getContextPath()%>/static/videos/bbs.mp4" type="video/mp4">
