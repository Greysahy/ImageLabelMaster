...
<div class="container">
    <div class="side-bar">
        ...
        <a class="side-bar-button" href="<%=request.getContextPath()%>/main/userspace/userSkillLearning_label.jsp" style="background-color: #087DCE;color:white;">如何进行标注</a>
        <a class="side-bar-button" href="<%=request.getContextPath()%>/main/userspace/userSkillLearning_exchange.jsp">如何赚取/兑换积分</a>
        <a class="side-bar-button" href="<%=request.getContextPath()%>/main/userspace/userSkillLearning_bbs.jsp">如何加入讨论</a>
    </div>
    <div class="tasks-content">
        <div class="up-area">
            <div class="video-title">
                <span class="video-title-text">如何进行标注👇</span>
            </div>
            <video id="teach-video" width="1080" height="640" controls>
                <source src="<%=request.getContextPath()%>/static/videos/label.mp4" type="video/mp4">
