...
<body>
<%
    List<Product> products = (List<Product>) request.getAttribute("SpecialPowerProducts");
%>
<div class="top-bar">
...
<div class="container">
    <div class="side-bar">
        ...
        <a class="side-bar-button" href="<%=request.getContextPath()%>/main/shoppingMall/SpecialPowerProducts" style="background-color: #087DCE;color:white;">特权权益</a>
    </div>
    <div class="tasks-content">
        <div class="choose-area">
            <form class="filter-form" action="<%=request.getContextPath()%>/main/shoppingMall/SpecialPowerProducts" method="post">
                所需积分
