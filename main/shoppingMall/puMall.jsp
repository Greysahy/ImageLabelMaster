...
<body>
<%
    List<Product> products = (List<Product>) request.getAttribute("PUProducts");
%>
<div class="top-bar">
...
<div class="container">
    <div class="side-bar">
        ...
        <a class="side-bar-button" href="<%=request.getContextPath()%>/main/shoppingMall/PU" style="background-color: #087DCE;color:white;">PU学分</a>
    ...
    <div class="tasks-content">
        <div class="choose-area">
            <form class="filter-form" action="<%=request.getContextPath()%>/main/shoppingMall/PU" method="post">
                <select name="type" style="height: 100%;margin:10px;" >
                    <option value="全部">全部</option>
                    <option value="学术科技与创新创业">学术科技与创新创业</option>
