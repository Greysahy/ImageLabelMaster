...
@WebServlet(urlPatterns = "/main/shoppingMall/RealProducts")
public class RealProductServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            List<Product> products = service.getRealProducts(minScore, maxScore);
            req.setAttribute("RealProducts", products);
            req.getRequestDispatcher("/main/shoppingMall/realAwardMall.jsp").forward(req, resp);
        } catch (Exception e) {
